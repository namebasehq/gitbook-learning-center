...
For example, to add a nameserver record to the `ns1` subdomain with IP address `44.231.6.183` (this is the default Namebase nameserver) you would add the first line as below:
